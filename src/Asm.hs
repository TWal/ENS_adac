module Asm (
    ...
    addOffset, getLabel, pushLabelName, popLabelName, getAssembly, star, int,
...
addOffset :: Integer -> Memory -> Memory
addOffset i (Pointer r off) = Pointer r (off+i)
addOffset i (PointerArray r ind scale off) = PointerArray r ind scale (off+i)
